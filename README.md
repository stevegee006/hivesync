...
|---|---|---|
| `0.2.4` | never | you want the container to run the same code until you decide otherwise |
...
This publishes `geaves006/hivesync:0.2.4` and `:latest`. Override the namespace
