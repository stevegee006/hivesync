...
[![version](https://img.shields.io/badge/version-0.2.7-3fb950)](https://github.com/stevegee006/hivesync/releases)
...
|---|---|---|
| `0.2.7` | never | you want the container to run the same code until you decide otherwise |
...
This publishes `geaves006/hivesync:0.2.7` and `:latest`. Override the namespace
