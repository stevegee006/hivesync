"""Tests for /api/health, which is M0's acceptance criterion."""
...
def test_health_reports_pinned_binary_versions(client: TestClient) -> None:
...
def test_version_mismatch_is_degraded_not_ok(app: FastAPI, client: TestClient) -> None:
...
def test_missing_binary_is_degraded_with_a_reason(app: FastAPI, client: TestClient) -> None:
